    ...
    <div className="space-y-6 sm:space-y-8 lg:space-y-12" data-aos="fade-up">
      <TermsSection icon={BookOpen} title="1. Definitions" delay={0}>
        ...
        <ul className="list-disc pl-5 sm:pl-6 space-y-1.5 sm:space-y-2 mb-3 sm:mb-4 marker:text-teal-300 light:marker:text-teal-700">
          <li><strong className="text-white light:text-gray-900">&quot;Service&quot;</strong> means our website, our blog, and all related features and pages.</li>
          <li><strong className="text-white light:text-gray-900">&quot;NexGen&quot;</strong> means our service-based team of freelance developers and designers, helping startups and local brands with AI/ML, chatbots, web &amp; app development, and digital marketing.</li>
          <li><strong className="text-white light:text-gray-900">&quot;Services&quot;</strong> means the development, design, marketing, and support services we provide to clients under separate service agreements.</li>
          <li><strong className="text-white light:text-gray-900">&quot;Blog&quot;</strong> means the articles and guides we publish on our blog section, typically focused on technology, business development, and related topics.</li>
        </ul>
        <p>
      ...
      <TermsSection icon={Users} title="4. Services" delay={0.2}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
          <div className="glass p-3 sm:p-4 rounded-2xl">
            <h3 className="font-bold text-sm sm:text-base text-white light:text-gray-900 mb-2">Development Services</h3>
            <ul className="text-xs sm:text-sm text-silver-light light:text-gray-700 space-y-1">
          ...
          <div className="glass p-3 sm:p-4 rounded-2xl">
            <h3 className="font-bold text-sm sm:text-base text-white light:text-gray-900 mb-2">Marketing & Design</h3>
            <ul className="text-xs sm:text-sm text-silver-light light:text-gray-700 space-y-1">
              <li>• SEO Services</li>
